var items = [];
var units = [];
var actLogID, SelItemName, previousDate, nextDate, newDate, intDate, intTime, tzoffset, dateIssued, newQty;
...
app.controller('stockIssCtrl', function($scope, $http, $uibModal, $log, $filter, $window){
	...
	.success(function(data,status,headers,config){
		...
		$uibModal.open({
			...
			resolve: {
				ErrorMsg : function () {
					return "Server Error Unable To Connet To The DataBase";
				}
			}	
		});
	});
	...
	$scope.addItem = function(itemCode, itemName, qty, desc, unit, proType){
